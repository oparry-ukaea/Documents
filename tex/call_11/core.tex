%Edit 0111 ZZZ to call document number nnnn 
%Edit FM-WP4 Code structure and coordination YYWP to Workpackage description
%Edit 3.4 YYACT to Activity number(s)
%Edit Establish standards for documentation and a testing framework YYTITLE to bid title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0111}%<==edit
...
\newcommand{\culhamtitle}{\LARGE \nep\ Activity 3.4  \\[1.0\baselineskip] Establish standards for documentation and a testing framework }%<==edit
...
FM-WP4 Code structure and coordination \ Activity 3.4 - Establish standards for documentation and a testing framework (Project \nep\ )
\paragraph*{Value}
2.0pm (Single Tender)
