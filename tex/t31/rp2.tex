...
\newcommand{\culhamtitle}{\LARGE Report on user frameworks for tokamak multiphysics  \\[1.0\baselineskip] M3.1.2 }%<==edit
...
\newcommand{\culhamdate}{June 30, 2020}%<=edit
\newcommand{\culhamdatea}{August 10, 2020}%<=edit
\newcommand{\culhamdateb}{June 30, 2020}%<=edit
...
% picture which cannot be wider than c.160mm.
...
\input{intro2}
\clearpage
\section{Selected Software in Detail}\label{sec:taskwork}
\input{body2}
\clearpage
...
\bibliography{../bib/new,../bib/waynes,../bib/misc,../bib/warv,../bib/neuts,../bib/reac,../bib/exc,../bib/active,../bib/dg1srt,../bib/picpapers,../bib/t31rp2}
