%Edit 0107 ZZZ to call document number nnnn 
%Edit FM-WP1 Numerical representation YYWP to Workpackage description
%Edit 2.7 YYACT to Activity number(s)
%Edit Investigate matrix-preconditioning techniques YYTITLE to bid title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0107}%<==edit
...
\newcommand{\culhamtitle}{\LARGE \nep\ Activity 2.7  \\[1.0\baselineskip] Investigate matrix-preconditioning techniques }%<==edit
...
FM-WP1 Numerical representation \ Activity 2.7 - Investigate matrix-preconditioning techniques (Project \nep\ )
\paragraph*{Value}
6.0pm
