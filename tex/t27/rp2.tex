...
%Edit 2.7.2 YYMILE to milestone number m.m.m
%Edit Report on preconditioner selection YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamtitle}{\LARGE Report on preconditioner selection  \\[1.0\baselineskip] M2.7.2 }%<==edit
