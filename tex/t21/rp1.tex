%Edit 0012 ZZZ to report number nnnn 
%Edit 2.1.1 YYMILE to milestone number m.m.m
%Edit Options for Geometry Representation YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0012}%<==edit
...
\newcommand{\culhamtitle}{\LARGE Options for Geometry Representation  \\[1.0\baselineskip] M2.1.1 }%<==edit
