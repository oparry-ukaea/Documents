...
%Edit 2.4.1 YYMILE to milestone number m.m.m
%Edit Assessment of which UQ methods are required to make 
%Edit \nep\ software actionable YYTITLE to report title - Words Start with Caps
...
\nep\ software actionable  \\[1.0\baselineskip] M2.4.1 }%<==edit
...
\newcommand{\culhamauthorb}{}%<==edit
\newcommand{\culhamauthorc}{}%<==edit
