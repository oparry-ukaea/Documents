%Edit 0001 ZZZ to call document number nnnn 
%Edit FM-WP1 Numerical representation YYWP to Workpackage description
%Edit 2.1 2.2 YYACT to Activity number(s)
%Edit Performance of Spectral Elements YYTITLE to bid title - Words Start with Caps
...
\newcommand{\culhamtitle}{\LARGE \nep\ Activity 2.1 2.2  \\[1.0\baselineskip] Performance of Spectral Elements }%<==edit
...
for Activity 2.1, 2.2 and \Papp 2-1, 2-D model of anisotropic heat transport.%<==omit
%\input{abst}%<==omit
%<==omit
%\vfill%<==omit
...
FM-WP1 Numerical representation \ Activity 2.1, 2.2 - Performance of Spectral Elements 
including anisotropic heat transport (Project \nep\ )
\paragraph*{Value}
26.0pm (Single Tender)
