...
%Edit exc  ep  Charter YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamtitle}{\LARGE \textbf{\nep} Charter }%<==edit
...
\input{abst}
\vfill
\hspace{-20mm}\includegraphics[width=22.0cm]{../corpics/jigs}
\end{titlepage}
