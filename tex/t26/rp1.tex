%Edit 0038 ZZZ to report number nnnn 
%Edit 2.6.1 YYMILE to milestone number m.m.m
%Edit Identification of a preferred overall numerical scheme YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0038}%<==edit
...
\newcommand{\culhamtitle}{\LARGE Identification of a preferred overall numerical scheme  \\[1.0\baselineskip] M2.6.1 }%<==edit
