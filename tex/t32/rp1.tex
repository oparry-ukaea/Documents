%Edit 0039 ZZZ to report number nnnn 
%Edit 3.2.1 YYMILE to milestone number m.m.m
%Edit Survey of code generators and their suitability for 
%Edit \nep  YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0039}%<==edit
...
\newcommand{\culhamtitle}{\LARGE Survey of code generators and their suitability for 
\nep   \\[1.0\baselineskip] M3.2.1 }%<==edit
