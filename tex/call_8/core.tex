%Edit 0108 ZZZ to call document number nnnn 
%Edit FM-WP2 Plasma multiphysics model YYWP to Workpackage description
%Edit 2.8 YYACT to Activity number(s)
%Edit Referent model for plasma edge region YYTITLE to bid title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0108}%<==edit
...
\newcommand{\culhamtitle}{\LARGE \nep\ Activity 2.8  \\[1.0\baselineskip] Referent model for plasma edge region }%<==edit
...
FM-WP2 Plasma multiphysics model \ Activity 2.8 - Referent model for plasma edge region (Project \nep\ )
\paragraph*{Value}
20.0pm (Single Tender)
