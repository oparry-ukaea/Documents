%Edit 0102 ZZZ to call document number nnnn 
%Edit FM-WP1 Numerical representation YYWP to Workpackage description
%Edit 2.3 YYACT to Activity number(s)
%Edit Optimal Use of Particles YYTITLE to bid title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0102}%<==edit
...
\newcommand{\culhamtitle}{\LARGE \nep\ Activity 2.3  \\[1.0\baselineskip] Optimal Use of Particles }%<==edit
...
FM-WP1 Numerical representation \ Activity 2.3 - Optimal Use of Particles (Project \nep\ )
\paragraph*{Value}
6.5pm (Single Tender)
