%Edit 0037 ZZZ to report number nnnn 
%Edit 2.8.1 YYMILE to milestone number m.m.m
%Edit Selection of the physics models YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0037}%<==edit
...
\newcommand{\culhamtitle}{\LARGE Selection of the physics models  \\[1.0\baselineskip] M2.8.1 }%<==edit
