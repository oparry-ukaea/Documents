...
\newcommand{\culhamtitle}{\LARGE Design patterns evaluation report  \\[1.0\baselineskip] M3.3.3 }%<==edit
...
\appendix
\section{Structure of a Game Engine}\label{sec:gamestruct}
\input{gamestruct}
\section{ECP \Papp\  standards}\label{sec:proxyapp_standards}
\input{proxyapp_standards}
