%Edit 0106n ZZZ to call document number nnnn 
%Edit FM-WP2 Plasma multiphysics model YYWP to Workpackage description
%Edit 2.6 YYACT to Activity number(s)
%Edit Plasma Fluid Referent Model via Exploratory \Papp s YYTITLE to bid title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0106n}%<==edit
...
\newcommand{\culhamtitle}{\LARGE \nep\ Activity 2.6  \\[1.0\baselineskip] Plasma Fluid Referent Model via Exploratory \Papp s }%<==edit
...
FM-WP2 Plasma multiphysics model \ Activity 2.6 - Plasma Fluid Referent Model via Exploratory \Papp s (Project \nep\ )
\paragraph*{Value}
3.0pm(single tender)
\paragraph*{Grant Funds for the period}
100\,\% FEC
\section{Aligns to work package [ FM-WP2 Plasma multiphysics model ]}
\input{align}
\section{Objectives}
\input{objectives}
