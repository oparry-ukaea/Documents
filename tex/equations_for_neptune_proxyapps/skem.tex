%Edit ZZZ ZZZ to report number nnnn 
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/ZZZ}%<==edit
...
under FM-WP3 as 3-1, 3-2, etc. %<==omit
%\input{abst}%<==omit
%%<==omit
%\vfill%<==omit
