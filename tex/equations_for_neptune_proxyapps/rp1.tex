...
\newcommand{\culhamissueno}{1.24}%<==edit
...
\newcommand{\culhamdate}{23 January 2023}%<=edit
\newcommand{\culhamdatea}{23 January 2023}%<=edit
\newcommand{\culhamdateb}{23 January 2023}%<=edit
...
%\input{sys28}
\clearpage
\section{Systems 3: Kinetic models}\label{sec:kin}
\input{sys3intro}
...
%\input{sys32}
%\clearpage
\section{System 3-3: Interaction with 2-D plasma model} \label{sec:sys3-3}
\input{sys33}
%\clearpage
...
\bibliography{../bib/new,../bib/waynes,../bib/misc,../bib/warv,../bib/neuts,../bib/reac,../bib/exc,../bib/active,../bib/dg1srt,../bib/mc.bib,../bib/picpapers}

\appendix
\section{Annex A: Atomic and Molecular Effects}\label{sec:atomic}
\input{atomic}
\section{Annex B: Index of Mathematics}\label{sec:mathsymb}
\input{tabsymbeqs}
