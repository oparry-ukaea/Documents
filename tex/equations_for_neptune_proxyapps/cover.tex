...
%Edit YYTITLE YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamtitle}{\LARGE Equations for \nep\ \Papp s}%<==edit
...
\input{abst}
\vfill
\hspace{-20mm}\includegraphics[width=22.0cm]{../corpics/eqs1}
\end{titlepage}
