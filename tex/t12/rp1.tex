%Edit 0011 ZZZ to report number nnnn 
%Edit 1.2.1 YYMILE to milestone number m.m.m
%Edit Year One Summary Report YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0011}%<==edit
...
\newcommand{\culhamtitle}{\LARGE Year One Summary Report  \\[1.0\baselineskip] M1.2.1 }%<==edit
