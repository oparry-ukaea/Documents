%Edit 0104 ZZZ to call document number nnnn 
%Edit FM-WP1 Numerical representation YYWP to Workpackage description
%Edit 2.4 YYACT to Activity number(s)
%Edit Study of Model Order Reduction (MOR) Techniques YYTITLE to bid title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0104}%<==edit
...
\newcommand{\culhamtitle}{\LARGE \nep\ Activity 2.4  \\[1.0\baselineskip] Study of Model Order Reduction (MOR) Techniques }%<==edit
...
FM-WP1 Numerical representation \ Activity 2.4 - Study of Model Order Reduction (MOR) Techniques (Project \nep\ )
\paragraph*{Value}
6.0pm 
