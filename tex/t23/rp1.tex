%Edit 0013 ZZZ to report number nnnn 
%Edit 2.3.1 YYMILE to milestone number m.m.m
%Edit Options for Particle Algorithms YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0013}%<==edit
...
\newcommand{\culhamtitle}{\LARGE Options for Particle Algorithms  \\[1.0\baselineskip] M2.3.1 }%<==edit
...
\newcommand{\culhamdate}{5 September 2020}%<=edit
\newcommand{\culhamdatea}{5 September 2020}%<=edit
\newcommand{\culhamdateb}{5 September 2020}%<=edit
...
\input{body}
\clearpage
\subsection{Storage Options}\label{sec:storage}
\input{storage}
\clearpage
