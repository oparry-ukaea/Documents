%Edit 0032 ZZZ to report number nnnn 
%Edit 3.3 YYMILE to milestone number m.m.m
%Edit Module Guide YYTITLE to report title - Words Start with Caps
...
\newcommand{\culhamissueno}{1.0}%<==edit
\newcommand{\culhamshorttitle}{CD/EXCALIBUR-FMS/0032}%<==edit
...
\newcommand{\culhamtitle}{\LARGE Module Guide  \\[1.0\baselineskip] D3.3 }%<==edit
...
\vspace*{-30mm}%<==omit
\includegraphics[width=2.5cm]{../corpics/cofaplus.png} \\[2.0\baselineskip]%<==omit
...
at the point of Deliverable 3.3. %<==omit
\input{abstc}%<==omit
%<==omit
\vfill%<==omit
